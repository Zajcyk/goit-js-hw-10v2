...
},{"_css_loader":"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/notiflix/build/notiflix-notify-aio.js":[function(require,module,exports) {
var define;
...
var fetchCountries = exports.fetchCountries = function fetchCountries(name) {
  var BASE_URL = 'https://restcountries.com/v3.1/name/';
  var properties = 'fields=name,capital,population,flags,languages';
  return fetch("".concat(BASE_URL).concat(name, "?").concat(properties)).then(function (response) {
...
// Import stylów CSS
// Import modułu Notify z biblioteki Notiflix
// Import funkcji debounce z biblioteki lodash
// Import funkcji fetchCountries z pliku fetchCountries.js

var DEBOUNCE_DELAY = 300; // Opóźnienie dla funkcji debounce
...
var refs = {
  ...
  // Kontener dla informacji o kraju
  countryList: document.querySelector('.country-list') // Lista krajów
};

// Funkcja do wyczyszczenia zawartości elementu HTML
var clearMarkup = function clearMarkup(ref) {
  return ref.innerHTML = '';
};

// Obsługa zdarzenia input
var inputHandler = function inputHandler(e) {
  var textInput = e.target.value.trim(); // Pobranie wartości wprowadzonej przez użytkownika
  ...
  (0, _fetchCountries.fetchCountries)(textInput).then(function (data) {
    ...
    if (data.length > 10) {
      clearMarkup(refs.countryList); // Wyczyszczenie listy krajów
      clearMarkup(refs.countryInfo); // Wyczyszczenie informacji o kraju
      _notiflixNotifyAio.Notify.info('Too many matches found. Please enter a more specific name'); // Wyświetlenie komunikatu informacyjnego
      return; // Zakończenie działania funkcji
    }
    ...
    clearMarkup(refs.countryList); // Wyczyszczenie listy krajów
    clearMarkup(refs.countryInfo); // Wyczyszczenie informacji o kraju
    _notiflixNotifyAio.Notify.failure('Oops..., there is no country with that name'); // Wyświetlenie komunikatu o błędzie
  });
};

// Funkcja do renderowania listy krajów
var renderMarkup = function renderMarkup(data) {
  // Sprawdzenie, czy liczba krajów wynosi 1
  if (data.length === 1) {
    clearMarkup(refs.countryList); // Wyczyszczenie listy krajów
    var markupInfo = createInfoMarkup(data); // Wygenerowanie znaczników HTML dla informacji o kraju
    refs.countryInfo.innerHTML = markupInfo; // Wstawienie znaczników HTML do kontenera informacji o kraju
  } else {
    clearMarkup(refs.countryInfo); // Wyczyszczenie informacji o kraju
    var markupList = createListMarkup(data); // Wygenerowanie znaczników HTML dla listy krajów
...
var createListMarkup = function createListMarkup(data) {
  return data.map(function (_ref) {
    var name = _ref.name,
      flags = _ref.flags;
    return "<li><img src=\"".concat(flags.png, "\" alt=\"").concat(name.official, "\" width=\"60\" height=\"40\">").concat(name.official, "</li>");
  }).join('');
};

// Funkcja do generowania znaczników HTML dla informacji o kraju
var createInfoMarkup = function createInfoMarkup(data) {
  return data.map(function (_ref2) {
    ...
    return "<img src=\"".concat(flags.png, "\" alt=\"").concat(name.official, "\" width=\"200\" height=\"100\">\n      <h1>").concat(name.official, "</h1>\n      <p>Capital: ").concat(capital, "</p>\n      <p>Population: ").concat(population, "</p>\n      <p>Languages: ").concat(Object.values(languages), "</p>");
  });
};

// Dodanie nasłuchiwania zdarzenia input z wykorzystaniem funkcji debounce
refs.searchEl.addEventListener('input', (0, _lodash.default)(inputHandler, DEBOUNCE_DELAY));
},{"./styles.css":"styles.css","notiflix/build/notiflix-notify-aio":"node_modules/notiflix/build/notiflix-notify-aio.js","lodash.debounce":"node_modules/lodash.debounce/index.js","./fetchCountries":"fetchCountries.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
